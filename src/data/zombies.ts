...
const BOSS_VARIANTS = {
  ...
  boss_monarch: variant(CORE_ZOMBIES.boss, { texture: 'zombie_boss_monarch', artTexture: 'art_zombie_boss_monarch_v1', role: '钢铁君主', element: 'kinetic', weak: ['explosive', 'toxic'], resist: ['fire', 'frost'], immune: ['kinetic'], hp: 2300, speed: 26, damage: 54, coin: 280, firstSeen: 35, threat: 5, palette: KINETIC, gimmick: '动能免疫，半血后启动攻城冲撞程序', counter: '爆破与腐蚀才能撼动君主重甲' }),
  boss_solar: variant(CORE_ZOMBIES.boss, { texture: 'zombie_boss_solar', artTexture: 'art_zombie_boss_solar_v1', role: '灼阳暴君', element: 'fire', weak: ['frost', 'toxic'], resist: ['explosive', 'energy'], immune: ['fire'], hp: 2600, speed: 27, damage: 58, coin: 320, firstSeen: 45, threat: 5, palette: FIRE, gimmick: '火焰免疫，半血后日冕全面点燃战场', counter: '寒冰持续压制并以腐蚀扩大伤口' }),
  boss_abyss: variant(CORE_ZOMBIES.boss, { texture: 'zombie_boss_abyss', artTexture: 'art_zombie_boss_abyss_v1', role: '渊狱霸主', element: 'gravity', weak: ['energy', 'lightning'], resist: ['kinetic', 'explosive'], immune: ['gravity'], hp: 2950, speed: 23, damage: 62, coin: 360, firstSeen: 55, threat: 5, palette: GRAVITY, gimmick: '引力免疫，半血后深渊裂隙持续增兵', counter: '能量与雷电穿透裂隙直击本体' }),
  boss_blight: variant(CORE_ZOMBIES.boss, { texture: 'zombie_boss_blight', artTexture: 'art_zombie_boss_blight_v1', role: '腐化大帝', element: 'toxic', weak: ['fire', 'energy'], resist: ['frost', 'kinetic'], immune: ['toxic'], hp: 3300, speed: 25, damage: 66, coin: 400, firstSeen: 65, threat: 5, palette: TOXIC, gimmick: '腐蚀免疫，半血后疫雾覆盖整条战线', counter: '火焰净化疫雾，能量锁定心脏' }),
  boss_radiant: variant(CORE_ZOMBIES.boss, { texture: 'zombie_boss_radiant', artTexture: 'art_zombie_boss_radiant_v1', role: '辉光至尊', element: 'energy', weak: ['kinetic', 'explosive'], resist: ['lightning', 'gravity'], immune: ['energy'], hp: 3700, speed: 28, damage: 70, coin: 450, firstSeen: 75, threat: 5, palette: ENERGY, gimmick: '能量免疫，半血后辉光阵列折射所有光束', counter: '动能穿甲与爆破轰开辉光护层' }),
  boss_omega: variant(CORE_ZOMBIES.boss, { texture: 'zombie_boss_omega', artTexture: 'art_zombie_boss_omega_v1', role: '终焉核心', element: 'explosive', weak: ['frost', 'gravity'], resist: ['fire', 'kinetic'], immune: ['explosive'], hp: 4200, speed: 24, damage: 76, coin: 520, firstSeen: 85, threat: 5, palette: BLAST, gimmick: '爆破免疫，半血后核心进入临界脉冲倒计时', counter: '寒冰与引力是抑制临界的关键' }),
} satisfies Record<string, ZombieDefinition>;
