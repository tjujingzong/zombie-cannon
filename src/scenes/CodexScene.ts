  ...
  private buildStrategy(): void {
    ...
    const guides: { title: string; body: string; color: number }[] = [
      ...
      },
      {
        ...
        color: 0xff6d00,
        body:
          '首领每 5 关出现一次，从第 5 关持续到第 95 关，共 11 种首领轮换登场。' +
          '首领半血进入二阶段，血量低于 22% 触发终末狂暴并召来精锐护航。' +
          '务必保留爆炸弹或激光等范围清场技能，集中火力击杀本体。',
      },
      {
        title: '优先击杀目标',
        color: 0xe53935,
      ...
      },
      {
        ...
        color: 0xffd180,
        body:
          '第 21 关起，大部分关卡会携带深渊词缀：急速之潮、钢铁尸潮、狂热浪潮、黄金时代、' +
          '脆弱前线、固守堡垒、超载反应、军械支援。词缀同时带来挑战与收益，' +
          '选关界面的关卡角标会提示本关词缀，善加利用可以事半功倍。',
      },
      {
        title: '精英词缀扩展',
        color: 0xff8a80,
        body:
          '精英敌人共有 8 种词缀：疾行、重甲、再生、分裂之外，新增爆燃（死亡引爆烈焰）、' +
          '庇护（为周围尸群补盾）、战号（加速周围尸群）、适应（逐渐抵抗所受元素）。' +
          '遇到适应词缀请尽快切换元素集火，别用单一弹药硬磨。',
      },
      {
        title: '弱点标记与打击节奏',
        color: 0x80deea,
        body:
          '命中敌人弱点元素会短暂标记目标，被标记的敌人承受更高伤害，深层扫描还能借此赚更多金币。' +
          '围绕元素克制组织火力，比无脑平推效率高得多。',
      },
      {
        title: '新流派 · 湮灭阵列与钢铁王朝',
        color: 0xff5252,
        body:
          '湮灭阵列走极限输出：玻璃大炮 + 泰坦重弹 + 过载聚变，用墙体风险换毁灭伤害。' +
          '钢铁王朝走绝对防御：保险协议 + 防爆闸门 + 自动焊机，让防线几乎不可能倒下。',
      },
      {
        title: '战前免费选技能',
        color: 0x4fc3f7,
